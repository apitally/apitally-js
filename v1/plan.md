...
- KTD6. **Spikes before code.** The design-js spikes (2-8; spike 1 was removed with D1's internals attach) run first (U2), timeboxed to hours each; results replace the spike section in `design-js.md`. Spike 4 (`eventName` support) runs first because it can change design details.
